...
class Placeholders {
  ...
  setExpandAnimation() {
    setTimeout(() => { // set timeout to make sure x position is set (parallax)
	  ...
	  const x4 = this.bounds.left - instances.slider.items[3].bounds.left;
	  ...
	  const y4 = this.bounds.top - instances.slider.items[3].bounds.top;
	  ...
	  const intersectX4 = constants.isDevice ? 0 : instances.slider.items[3].x;
